package com.promineotech.intentoryManagement.service;
...
import com.promineotech.intentoryManagement.repository.CustomerRepository;
import com.promineotech.intentoryManagement.repository.OrderRepository;
import com.promineotech.intentoryManagement.repository.ProductRepository;
import com.promineotech.intentoryManagement.util.MembershipLevel;
import com.promineotech.intentoryManagement.util.OrderStatus;
...
public class OrderService {
	...
	public Order submitNewOrder(Set<Long> productIds, Long customerId) throws Exception {
		try {
			...
			Logger.error("Exception ocurred while trying to create new order for customer: " + customerId, e);
			throw e;
		}
	}
	...
	public Order completeOrder(Long orderId) throws Exception {
		try {
			...
			Logger.error("Exception ocurred while trying to complete order: " + orderId, e);
			throw new Exception("Unable to update order.");
		}
	}
